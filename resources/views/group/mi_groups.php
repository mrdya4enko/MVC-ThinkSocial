        <div class="w3-col m6 groups">
            <div class="panel">
                <div class="group-control">
                    <a href="../../../index.php" class="w3-btn w3-ripple w3-orange small"> My Groups </a>
            ...
            <?php foreach ($myGroups as $myGroup) : ?>
                ...
                <img src="<?=$myGroup->groupsAvatars[0]->fileName;?>" class="group-card__avatar" width="100px" height="100px">
                <div class="group-desc">
                    <a href="group/<?=$myGroup->group->id;?>" class="group-card__group-name"> <?=$myGroup->group->name;?> </a>
                    <div class="group-card__desc"> <?=$myGroup->group->description;?> </div>
                </div>
                <a href="group/edit/<?=$myGroup->group->id;?>" class="group-card__subs w3-btn w3-ripple w3-teal"> Manage </a>
            </section>
            <?php endforeach; ?>

            <?php foreach ($Groups as $Group) : ?>
            <section class="group-card">
                <img src="<?=$Group->groupsAvatars[0]->fileName;?>" class="group-card__avatar" width="100px" height="100px">
                <div class="group-desc">
                    <a href="group/<?=$Group->group->id;?>" class="group-card__group-name"> <?=$Group->group->name;?> </a>
