        <div class="w3-col m6 groups">
            <div class="panel">
                <div class="group-control">
                    <a href="../../../index.php" class="w3-btn w3-ripple w3-blue small"> My Groups </a>
            ...
            <section class="group-card">
                <img src="<?=$findGroup->groupsAvatars[0]->fileName;?>" class="group-card__avatar" width="100px" height="100px">
                <div class="group-desc">
                    <a href="group/<?=$findGroup->group->id;?>" class="group-card__group-name"> <?=$findGroup->group->name;?> </a>
