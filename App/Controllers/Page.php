...
Class Page Extends ControllerBase
{
    ...
    protected function getControllerVars()
    {
        ...
        $userAvatar = \App\Models\UserAvatar::getByForeign(array('user_id' => $this->args['user_id']), " AND status='active'");
        ...
        $userCities = \App\Models\UserCity::getByForeign(array('user_id' => $this->args['user_id']), " ORDER BY created_at");
        ...
        $userGroups = \App\Models\UserGroup::getByForeign(array('user_id' => $this->args['user_id']), "");
        foreach ($userGroups as $userGroup) {
            $userGroup->group = \App\Models\Group::getByID($userGroup->group_id);
        }
        $userAlbums = \App\Models\AlbumUser::getByForeign(array('user_id' => $this->args['user_id']), "");
        $commentPhotosNum = 0;
        ...
        $userNews = \App\Models\UserNews::getByForeign(array('user_id' => $this->args['user_id']), "");
        $commentNewsNum = 0;
        ...
        $friendReqs = \App\Models\Friend::getByForeign(array('user_receiver' => $this->args['user_id']), " AND status='unapplied' ORDER BY created_at DESC");
        ...
        $unreadMessagesNum = \App\Models\Message::count(array('receiver_id' => $this->args['user_id']), " AND status='unread'");
