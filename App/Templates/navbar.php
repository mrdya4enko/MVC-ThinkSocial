...
<div class="w3-top">
    <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
        ...
        <li class="w3-hide-small w3-right"><a href="http://ts.local/user/logout/" class="w3-padding-large w3-hover-white" title="Logout"><img src="../avatars/<?=$userAvatar->file_name?>" class="w3-circle" style="height:25px;width:25px" alt="Avatar"></a></li>
    </ul>
</div>
